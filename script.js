...
window.addEventListener('load', function () {
  ...
  var h1Text = ' I am Julfikar Rayim';
  var pText = 'I am a Font end Web developer I have 5 month experience For Html css js and Bootstrap. and i loran php';
  ...
  // Start typing for h1 and p elements
    typeText( okElement, okText, typingSpeed);
